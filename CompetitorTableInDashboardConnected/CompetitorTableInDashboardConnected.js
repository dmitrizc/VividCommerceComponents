...
import CompetitorTableInDashboard from 'CompetitorTableInDashboard';

import './CompetitorTableInDashboardConnected.scss';
...
class CompetitorSummaryTableConnected extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="competitor-summary-table--dashboard-connected">
        <CompetitorTableInDashboard
          data={data}
          sorted={[]}
          onSortedChange={null}
